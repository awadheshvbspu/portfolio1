...
export default function Data() {
  return (
    <div className='home__data'>
        <h1 className='home__title'>Awadhesh Yadav
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        I'm a frontend Developer , and I'm very passionate and dedicated to my work and create a responsive design.
        </p>
        <a href='#contact' className='button button--flex'>
            Say Hello <FaTelegramPlane size={25}/>
        </a>
    </div>
  )
}
